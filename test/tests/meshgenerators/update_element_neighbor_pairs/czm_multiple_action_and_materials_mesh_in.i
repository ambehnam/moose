[Mesh]
  ...
  file = czm_multiple_action_and_materials_in.e
  []
  [./subdomain_id]
    input = msh
    type = UpdateNeighborElementPairs
    adj_sidesets = 'Block0_Block1 Block1_Block2 Block2_Block3'
    sep_sidesets = 'Block1_Block0'    
    csv_file = pbc_deip_multiple_action.csv
  [../]
[]
