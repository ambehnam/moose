...
#include "TestPeriodicAD.h"

registerMooseObject("MooseTestApp", TestPeriodicAD);

InputParameters
TestPeriodicAD::validParams()
{
...
TestPeriodicAD::TestPeriodicAD(const InputParameters & parameters)
...
void
TestPeriodicAD::precalculateResidual()
{
  precalculateStability();
}
void
TestPeriodicAD::precalculateJacobian()
{
  precalculateStability();
}

void
TestPeriodicAD::computeResidualScalar()
{
...
void
TestPeriodicAD::computeJacobianScalar()
{
...
void
TestPeriodicAD::computeOffDiagJacobianScalar(Moose::MortarType mortar_type, unsigned int jvar)
{
  if (jvar != _kappa_var)
    return;
...
Real
TestPeriodicAD::computeQpResidual(const Moose::MortarType mortar_type)
{
...
ADReal
TestPeriodicAD::computeQpResidualScalar()
{
...
ADReal
TestPeriodicAD::computeQpResidualScalarScalar()
{
...
// Real
// TestPeriodicAD::computeQpJacobianScalarScalar()
// {
...
Real
TestPeriodicAD::computeQpBaseJacobian(const Moose::MortarType mortar_type,
...
Real
TestPeriodicAD::computeQpConstraintJacobian(const Moose::MortarType mortar_type,
                                              const unsigned int /*jvar*/)
{
...
void
TestPeriodicAD::precalculateStability()
{
...
void
TestPeriodicAD::precalculateMaterial()
{
